    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">AIMS</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">AIMS</span> <span class="clr-green md">Canteen</span></div>
...
if (signModal) {
    ...
    <div class="modal-container">
        ...
        <div class="text-center my-1">
            <a href="#" id="forgot-password-link" style="color: #28a745; text-decoration: none; font-size: 14px;">
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>AIMS Institutes Bangalore is a premier private institute
                         established in 1994. It is accredited by the NAAC with a grade
                         ‘A’ and is also certified by the International Accreditation Council
                           for Business Education (IACBE).</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/AIMS1994/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/aimsinstitutes1994?igsh=bHFnejhkd2Q4OGY5" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://www.theaims.ac.in/" target="_blank">AIMS INSTITUTES</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>080 28390433/34</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>https://www.theaims.ac.in/</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>1st Cross, 1st Stage, Peenya, Bengaluru 560058, Karnataka, INDIA.</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: www.theaims.ac.in</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    <div></div>
                    <div class="">Designed & Developed By <a href="#">AIMS STUDENTS</a></div>
                </main>
            </section>
        `;
        })
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>AIMS Institutes Bangalore is a premier private institute
                         established in 1994. It is accredited by the NAAC with a grade 
                         ‘A’ and is also certified by the International Accreditation 
                         Council for Business Education (IACBE).</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/AIMS1994/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/aimsinstitutes1994?igsh=bHFnejhkd2Q4OGY5" target="_blank">Instagram</a></li>
                        </ul>
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="https://www.theaims.ac.in" target="_blank">AIMS INSTITUTE</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
